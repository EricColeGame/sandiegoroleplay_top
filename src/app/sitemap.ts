...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://sandiegoroleplay.top";

  // Static paths that always exist
  const staticPaths = ["/", "/guide", "/codes", "/roles", "/features", "/money", "/updates", "/community", "/privacy-policy", "/terms-of-service", "/copyright", "/about"];
